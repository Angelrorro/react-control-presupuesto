        ...
        <div className='modal'>
            ...
            <form action="" className={`formulario ${animarModal ? 'animar' : 'cerrar'}`} onSubmit={handleSubmit}>
                ...
                <div className="campo">
                    ...
                    <input type="number" placeholder='Añade la cantidad del gasto: ej. 400' id='cantidad' value={cantidad} onChange={e => setCantidad(Number(e.target.value)) } />
                </div>
                <div className="campo">
                    ...
                    <select id="categoria" value={categoria} onChange={e => setCategoria(e.target.value) }>
                        ...
                        <option value="gastos">Gastos de varios</option>
